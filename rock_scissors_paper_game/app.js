...
const userName = ' (승호)'.fontsize(3).sup();
const compName = ' (컴퓨터)'.fontsize(3).sup();
result_div.innerHTML = `<p>${convertCase(user)}${userName} beats ${convertCase(computer)}${compName}. 승호가 이겼군!</p>`;
...
const userName = ' (승호)'.fontsize(3).sup();
const compName = ' (컴퓨터)'.fontsize(3).sup();
result_div.innerHTML = `<p>${convertCase(computer)}${compName} beats ${convertCase(user)}${userName}. 승호가 졌어!</p>`;
const roundStatus = document.getElementById(user);
...
const userName = ' (승호)'.fontsize(3).sup();
const compName = ' (컴퓨터)'.fontsize(3).sup();
result_div.innerHTML = `<p>비겼다. 우리 둘 다 ${convertCase(user)}를 냈어.</p>`;
